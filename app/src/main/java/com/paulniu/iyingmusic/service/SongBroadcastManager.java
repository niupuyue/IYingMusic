 ...
 * Version:
 */
public class SongBroadcastManager {
    ...
    private static SongBroadcastManager mInstance;

    private SongBroadcastManager() {
    }

    public static SongBroadcastManager getInstance() {
        if (mInstance == null) {
            mInstance = new SongBroadcastManager();
        }
        return mInstance;
    }
